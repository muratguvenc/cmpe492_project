	...
	<body>
		<div ng-app="diffusion">
			<div ng-controller="DiffusionController">
				...
				<span style="position:absolute; left:755px; top:130px" >{{view.distanceBetweenTwoCells}}</span>
				...
				<span style="position:absolute; left:755px; top:170px" >{{view.cellRadius}}</span>
				...
				<span style="position:absolute; left:755px; top:210px" >{{view.temperature}}</span>
				...
				<span style="position:absolute; left:755px; top:290px" >{{view.moleculeSize}}</span>
